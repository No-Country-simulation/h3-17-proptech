...
export default function LandingPage (){
    ...
    const smartInv = (
        ...
        <div id="smartInvAside">
            ...
            <p id="investText">
            Sé parte del cambio: financia oportunidades habitacionales, diversifica tu portafolio y genera rendimientos sólidos con total transparencia.
            Conecta con compradores, impulsa el desarrollo y construye un legado que trascienda.
            </p>
